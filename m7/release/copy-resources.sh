...
OPTS=$(getopt --alternative --name copy-resources --options $SHORT_OPTS --longoptions $LONG_OPTS -- "$@")
...
copy_application() {
    ...
    kubectl -n $WORKSPACE delete gitopsdeployments --all
}
...
show_help() {
    echo "Usage:"
    echo "  copy-resources [OPTION]... WORKSPACE"
